      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          ...
          case AppRoutes.profileEdit:
            final args = settings.arguments as Map<String, dynamic>?;
            return MaterialPageRoute(
              builder: (_) => EditProfilePage(existingProfile: args),
            );
    ...
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          // Or return const WelcomeScreen(); if you have a welcome screen.
        }
      },
    );
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Widget> _pages = [
    ...
    const ViewProfilePage(), // <-- Show profile view page here
  ...
  Future<void> _confirmLogout() async {
    ...
    if (shouldLogout == true) {
      ...
      // AuthGate will detect sign out and redirect to WelcomeScreen
    }
  }
